...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Maintained the core product, FVS (Fusion Vision System), an embedded device based on \textbf{Yocto}, using \textbf{GTK Clutter} for the user interface and \textbf{GStreamer} for camera capturing and video streaming.}
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{\underline{\href{https://github.com/linj121/qtCannyEdgeDetection}{qtCannyEdgeDetection}}} $|$ \emph{Qt6, QML, C++, CMake, OpenCV}}{December 2023}
          \resumeItemListStart
            \resumeItem{Build a user friendly GUI application for Canny Edge Detection using \textbf{Qt6} and \textbf{QML}, and integrated \textbf{OpenCV} for image processing}
            \resumeItem{Improved performance by utilizing \textbf{multithreading} to process images concurrently, which reduced post-processing time by OpenCV}
          \resumeItemListEnd
      \resumeProjectHeading
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
      \textbf{Languages}{: C, C++, TypeScript, Python} \\
      \textbf{Tools}{: Qt6, QML, CMake, Git, Tmux, Vim, OpenCV, FFmpeg, GStreamer} \\
      \textbf{Web}{: React, Express, NextJS, MongoDB, Postman} \\
