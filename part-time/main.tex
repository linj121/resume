...
\begin{document}
    ...
    \section{About Me}
        ...
        \begin{onecolentry}
            Dependable and detail-oriented professional with hands-on experience in customer service and operations. Skilled in maintaining high safety and quality standards, collaborating effectively in diverse teams, and excelling in fast-paced environments. Known for strong work ethic, adaptability, and a proactive approach to problem-solving. Committed to contributing to organizational success by ensuring operational efficiency, cleanliness, and seamless coordination across processes.
        \end{onecolentry}
