...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
      ...
      \textbf{Languages}{: C\#, SQL, JavaScript, HTML/CSS, Python,  TypeScript, Java, C++} \\
      ...
      \textbf{Backend}{: ASP.NET, Entity Framework Core, xUnit, NodeJS, PostgreSQL, SQLite, Redis, Swagger } \\
      % TODO: learn and apply: Prometheus, Grafana, Terraform, Jenkins, (K8s, ArgoCD?)
      % TODO: get an AWS cert 
      \textbf{Others}{: Pandas, Numpy, GCP, AWS, Docker, GitHub Actions, Nginx } \\
      ...
      {Longan Vision Corp.}{Hamilton, ON}
        ...
        \resumeSubSubheading{Backend}{}
          \resumeItemListStart
            ...
            \resumeItem{Reduced bandwidth and resource consumption for IoT devices by transforming WebRTC from P2P mesh network to a client-server architecture using a C++ media server as a Selective Forwarding Unit.}
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
        {\textbf{Convo, a SaaS platform for automating instant messaging apps} $|$ \faGithub \thinspace \thinspace \href{https://github.com/linj121/convo}{\underline{github.com/linj121/convo}}}{July 2024 - Now}
        \resumeItemListStart
          \resumeItem{Implemented a highly customizable plugin system and a task scheduler system for instant messaging apps (eg. WhatsApp) using \textbf{NodeJS}, \textbf{TypeScript} and \textbf{Prisma} (SQLite3).}
