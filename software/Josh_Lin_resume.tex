      ...
      {Longan Vision Corp.}{Hamilton, ON}
        ...
        \resumeSubSubheading{Backend}{}
          \resumeItemListStart
            ...
            \resumeItem{Secured media resources by implementing user authentication and RBAC through \textbf{REST APIs} with token-based validation, using \textbf{C\#}, \textbf{ASP.NET Core}, \textbf{Entity Framework} and \textbf{Google Firebase SDK}.}
          \resumeItemListEnd
        % devops
